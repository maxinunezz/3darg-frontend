...
import { ArrowRight, Layers, Ruler, GraduationCap, Instagram, Youtube } from "lucide-react";
  ...
  return (
    <>
      ...
      <section className="theme-ink relative overflow-hidden">
        ...
        >
          <p className="font-mono text-[11px] tracking-[0.34em] uppercase text-[var(--ink-500)]">
            Impresión 3D · Diseño paramétrico · Argentina
          </p>
          ...
          >
            <span className="block text-white">Traenos el problema</span>
            <span className="block" style={{ color: "rgba(250,248,245,.34)" }}>
              que nadie pudo <span className="text-[var(--accent)]">resolver</span>
            </span>
          </h1>

          <p className="max-w-[44ch] text-[var(--ink-300)]" style={{ lineHeight: 1.7 }}>
            Diseñamos y fabricamos piezas a medida cuando el catálogo se queda corto. Tolerancias
            verificadas, materiales técnicos y entregas puntuales.
          </p>

          <div className="flex flex-wrap items-center justify-center gap-3 mt-2">
            <Link href="/shop" className={buttonClass("ember", "lg")}>
              Ver productos <ArrowRight size={16} strokeWidth={1.5} />
            </Link>
            ...
            <FeatureCard
              ...
              desc={
                <ul className="grid gap-1.5 font-mono text-[13px]">
                  <li>— Repuestos descontinuados</li>
                  <li>— Prototipos funcionales</li>
                  <li>— Series cortas a medida</li>
                </ul>
              }
            />
            <FeatureCard
              ...
              desc={
                <ul className="grid gap-1.5 font-mono text-[13px]">
                  <li>— Escaneo y relevamiento</li>
                  <li>— Modelado paramétrico</li>
                  <li>— Ajuste por iteración</li>
                </ul>
              }
            />
            <FeatureCard
              ...
              desc={
                <ul className="grid gap-1.5 font-mono text-[13px]">
                  <li>— Video tutoriales gratis</li>
                  <li>— Consejos de impresión</li>
                  <li>— Comunidad en redes</li>
                </ul>
              }
            />
          </div>
      ...
      <section className="py-[var(--section-y)] px-[var(--gutter)]" style={{ background: "var(--surface-inset)" }}>
        <div className="max-w-[var(--container)] mx-auto grid gap-10">
          <SectionHeading eyebrow="Proceso" index={3} title="De la idea a la pieza terminada" />
      ...
      <section className="py-[var(--section-y)] px-[var(--gutter)]">
        <div className="max-w-[var(--container)] mx-auto grid gap-10">
          <SectionHeading eyebrow="El detalle, de cerca" index={4} title="Lo que se nota al tocarlo" />
          <div className="hairline-grid grid grid-cols-1 md:grid-cols-3">
            {[
      ...
      <section className="py-[var(--section-y)] px-[var(--gutter)]">
        <div className="max-w-[var(--container)] mx-auto grid gap-10 lg:grid-cols-[1.05fr_.95fr] items-center">
          <div className="grid gap-5">
            <SectionHeading eyebrow="Enseñanza" index={5} title="Lo que sabemos, lo compartimos gratis" />
            <p className="text-[var(--text-muted)] leading-[var(--leading-body)] max-w-[52ch]">
              No damos talleres pagos: enseñamos en video por redes, con lo que aprendimos
              imprimiendo todos los días. Materiales, ajustes de máquina y errores comunes,
